...
Pour sélectionner des lignes et des colonnes dans un `data.frame` nous pouvons utiliser les crochets (`df[criteres_de_selection_des_lignes,  criteres_de_selection_des_colonnes]`)
...
pie(table(hdv2003$occup), col = cols)

# Histogramme
barplot(table(hdv2003$occup), col = cols, las=2, cex.names = 0.6)
